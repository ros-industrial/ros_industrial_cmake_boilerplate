...
---------------------------------------------
This CMake macro calls find_package(GTest REQUIRED) and checks for the following targets GTest::GTest and GTest::Main.
If the targets are missing it will create the targets using the CMake variables.
